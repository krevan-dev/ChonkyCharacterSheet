...
ns.optionDefs = {
    ...
    { type="header", cat="GENERAL", ver=bit.bor(CCS.ALL), key=nil, label=L["HEADER_MODULE_SIZE"], slots=4, color={0.7, 0.5, 1.0}, fontSize=20, fontOutline="THICKOUTLINE" },
    { type="divider", cat="GENERAL", ver=bit.bor(CCS.ALL), slots=4 },
    { type="checkbox", cat="GENERAL", ver=bit.bor(CCS.ALL), key="showcharacterstats", label=L["SHOW_CHARACTER_STATS"], value=true, default=true, slots=1 },
    ...
    { type="divider", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), slots=4 },
    { type="color", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), key="bgcolor", label=L["CCS_BG_COLOR"], value={0,0,0,0.89}, default={0,0,0,0.89}, slots=2 },
    { type="dropdown", cat="CHAR-SHEET", ver=bit.bor(CCS.RETAIL), key="bgtype", label=L["BG_TYPE"], value="Default", default="Default", values={"Default", "Class", "Race", "Hide"}, slots=2 },
    { type="divider", cat="CHAR-SHEET", ver=bit.bor(CCS.RETAIL), slots=4 },
    { type="header", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), key=nil, label=L["HEADER_ITEM_DISPLAY"], slots=4, color={0.7, 0.5, 1.0}, fontSize=16, fontOutline="THICKOUTLINE" },
    { type="divider", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), slots=4 },
    ...
    { type="divider", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), slots=4 },
    { type="header", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), key=nil, label=L["HEADER_LOOT_SPEC"], slots=4, color={0.7, 0.5, 1.0}, fontSize=16, fontOutline="THICKOUTLINE" },
    { type="divider", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), slots=4 },
    { type="checkbox", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), key="showlootspec", label=L["SHOW_LOOT_SPEC"], value=true, default=true, slots=1 },
    { type="checkbox", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), key="showlootspectitle", label=L["SHOW_LOOT_SPEC_TITLE"], value=true, default=true, slots=1 },

    -- Spec Display Options
    { type="divider", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), slots=4 },
    { type="header", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), key=nil, label=L["HEADER_SPEC_DISPLAY"], slots=4, color={0.7, 0.5, 1.0}, fontSize=16, fontOutline="THICKOUTLINE" },
    { type="divider", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), slots=4 },
    { type="checkbox", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), key="showspec", label=L["SHOW_SPEC"], value=true, default=true, slots=1 },
    { type="checkbox", cat="CHAR-SHEET", ver=bit.bor(CCS.ALL), key="showspectitle", label=L["SHOW_SPEC_TITLE"], value=true, default=true, slots=1 },

    -- Character Sheet Font Settings
    { type="divider", cat="CHAR-FONT", ver=bit.bor(CCS.ALL), slots=4 },
    { type="header", cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key=nil, label=L["HEADER_FONT_SETTINGS"], slots=4, color={0.7, 0.5, 1.0}, fontSize=20, fontOutline="THICKOUTLINE" },
    { type="divider", cat="CHAR-FONT", ver=bit.bor(CCS.ALL), slots=4 },
    ...
    { type="font",   cat="CHAR-FONT", ver=bit.bor(CCS.ALL),   key="fontname_reputation", label=L["FONT_NAME_REPUTATION"], value="Fonts\\FRIZQT__.TTF", default="Fonts\\FRIZQT__.TTF", slots=2 },
    { type="slider", cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontsize_reputation", label=FONT_SIZE, value=10, default=10, min=3, max=36, step=1, slots=1 },
    { type="color",  cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontcolor_reputation", label=COLOR, value={1,1,1,1}, default={1,1,1,1}, slots=1 },
    { type="font",   cat="CHAR-FONT", ver=bit.bor(CCS.ALL),   key="fontname_repstanding", label=L["FONT_NAME_REPSTANDING"], value="Fonts\\FRIZQT__.TTF", default="Fonts\\FRIZQT__.TTF", slots=2 },
    { type="slider", cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontsize_repstanding", label=FONT_SIZE, value=10, default=10, min=3, max=36, step=1, slots=1 },
    { type="color",  cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontcolor_repstanding", label=COLOR, value={1,1,1,1}, default={1,1,1,1}, slots=1 },
    ...
    { type="font",   cat="CHAR-FONT", ver=bit.bor(CCS.ALL),   key="fontname_showchar", label=L["FONT_NAME_SHOWCHAR"], value="Fonts\\FRIZQT__.TTF", default="Fonts\\FRIZQT__.TTF", slots=2 },
    { type="slider", cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontsize_showchar", label=FONT_SIZE, value=10, default=10, min=3, max=36, step=1, slots=1 },
    { type="color",  cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontcolor_showchar", label=COLOR, value={1,1,1,1}, default={1,1,1,1}, slots=1 },
    { type="font",   cat="CHAR-FONT", ver=bit.bor(CCS.ALL),   key="fontname_lootspec", label=L["FONT_NAME_LOOTSPEC"], value="Fonts\\FRIZQT__.TTF", default="Fonts\\FRIZQT__.TTF", slots=2 },
    { type="slider", cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontsize_lootspec", label=FONT_SIZE, value=10, default=10, min=3, max=34, step=1, slots=1 },
    { type="color",  cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontcolor_lootspec", label=COLOR, value={1,1,1,1}, default={1,1,1,1}, slots=1 },
    { type="font",   cat="CHAR-FONT", ver=bit.bor(CCS.ALL),   key="fontname_specs", label=L["FONT_NAME_SPECS"], value="Fonts\\FRIZQT__.TTF", default="Fonts\\FRIZQT__.TTF", slots=2 },
    { type="slider", cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontsize_specs", label=FONT_SIZE, value=10, default=10, min=3, max=34, step=1, slots=1 },
    { type="color",  cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontcolor_specs", label=COLOR, value={1,1,1,1}, default={1,1,1,1}, slots=1 },

    -- Character Stats Section
    { type="divider", cat="CHAR-STATS", ver=bit.bor(CCS.ALL), slots=4 },
    { type="header", cat="CHAR-STATS", ver=bit.bor(CCS.ALL), key=nil, label=L["HEADER_STATS_MODULE"], slots=4, color={0.7, 0.5, 1.0}, fontSize=20, fontOutline="THICKOUTLINE" },
    { type="divider", cat="CHAR-STATS", ver=bit.bor(CCS.ALL), slots=4 },
    { type="checkbox", cat="CHAR-STATS", ver=bit.bor(CCS.ALL), key="show_headers", label=L["SHOW_HEADERS"], value=true, default=true, slots=1 },
    { type="checkbox", cat="CHAR-STATS", ver=bit.bor(CCS.ALL), key="ccs_stats_solidbg", label=L["SOLID_BG"], value=false, default=false, slots=1 },
    { type="slider", cat="CHAR-STATS", ver=bit.bor(CCS.ALL), key="round", label=L["STATS_ROUNDING"], value=2, default=2, min=0, max=2, step=1, slots=2 },
    { type="checkbox", cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="show_secondarypriority", label=L["Show wowhead recommended secondary stat priority"], value=false, default=false, slots=4 },
    { type="divider", cat="CHAR-STATS", ver=bit.bor(CCS.ALL), slots=4 },

    { type="checkbox", cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="show_attributes", label=L["SHOW_ATTRIBUTES"], value=true, default=true, slots=2 },
    { type="color",    cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="ccs_attribute_color", label=L["BGCOLOR_ATTRIBUTES"], value={0.64, 0.47, 0.1, 0.4}, default={0.64, 0.47, 0.1, 0.4}, slots=2 }, -- Gold


    { type="checkbox", cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="show_secondary_stats", label=L["SHOW_SECONDARY_STATS"], value=true, default=true, slots=2 },
    { type="color",    cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="ccs_secondary_stats_color", label=L["BGCOLOR_SECONDARY_STATS"], value={0.16, 0.34, 0.08, 0.4}, default={0.16, 0.34, 0.08, 0.4}, slots=2 }, -- Dark Green

    { type="checkbox", cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="show_attack_stats", label=L["SHOW_ATTACK_STATS"], value=true, default=true, slots=2 },
    { type="color",    cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="ccs_attack_stats_color", label=L["BGCOLOR_ATTACK_STATS"], value={0.41, 0, 0, 0.4}, default={0.41, 0, 0, 0.4}, slots=2 }, -- Dark Red

    { type="checkbox", cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="show_defense_stats", label=L["SHOW_DEFENSE_STATS"], value=true, default=true, slots=2 },
    { type="color",    cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="ccs_defense_stats_color", label=L["BGCOLOR_DEFENSE_STATS"], value={0, 0.13, 0.38, 0.4}, default={0, 0.13, 0.38, 0.4}, slots=2 }, -- Dark Blue

    { type="checkbox", cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="show_general_stats", label=L["SHOW_GENERAL_STATS"], value=true, default=true, slots=2 },
    { type="color",    cat="CHAR-STATS", ver=bit.bor(CCS.RETAIL), key="ccs_general_color", label=L["BGCOLOR_GENERAL_STATS"], value={0.45, 0.45, 0.45, 0.4}, default={0.45, 0.45, 0.45, 0.4}, slots=2 }, -- Gray
    
    -- Stats Font Settings
    { type="divider", cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), slots=4 },
    { type="header", cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), key=nil, label=L["HEADER_STATS_FONT"], slots=4, color={0.7, 0.5, 1.0}, fontSize=20, fontOutline="THICKOUTLINE" },
    { type="divider", cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), slots=4 },
    { type="font",   cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL),   key="fontname_cilvl", label=L["FONT_NAME_CILVL"], value="Fonts\\FRIZQT__.TTF", default="Fonts\\FRIZQT__.TTF", slots=2 },
    { type="slider", cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), key="fontsize_cilvl", label=FONT_SIZE, value=20, default=20, min=3, max=34, step=1, slots=1 },

    { type="font",   cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL),   key="fontname_hppower", label=L["FONT_NAME_HPPOWER"], value="Fonts\\FRIZQT__.TTF", default="Fonts\\FRIZQT__.TTF", slots=2 },
    { type="slider", cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), key="fontsize_hppower", label=FONT_SIZE, value=12, default=12, min=3, max=34, step=1, slots=1 },
    { type="color",  cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), key="fontcolor_hppower", label=COLOR, value={1,1,1,1}, default={1,1,1,1}, slots=1 },

    { type="font",   cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL),   key="fontname_statheaders", label=L["FONT_NAME_STATHEADERS"], value="Fonts\\FRIZQT__.TTF", default="Fonts\\FRIZQT__.TTF", slots=2 },
    { type="slider", cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), key="fontsize_statheaders", label=FONT_SIZE, value=14, default=14, min=3, max=34, step=1, slots=1 },
    { type="color",  cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), key="fontcolor_statheaders", label=COLOR, value={1,1,1,1}, default={1,1,1,1}, slots=1 },

    { type="font",   cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL),   key="fontname_statname", label=L["FONT_NAME_STATNAME"], value="Fonts\\FRIZQT__.TTF", default="Fonts\\FRIZQT__.TTF", slots=2 },
    { type="slider", cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), key="fontsize_statname", label=FONT_SIZE, value=10, default=10, min=3, max=34, step=1, slots=1 },
    { type="color",  cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), key="fontcolor_statname", label=COLOR, value={1,1,1,1}, default={1,1,1,1}, slots=1 },

    { type="font",   cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL),   key="fontname_stats", label=L["FONT_NAME_STATS"], value="Fonts\\FRIZQT__.TTF", default="Fonts\\FRIZQT__.TTF", slots=2 },
    { type="slider", cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), key="fontsize_stats", label=FONT_SIZE, value=10, default=10, min=3, max=34, step=1, slots=1 },
    { type="color",  cat="CHAR-STATS-FONT", ver=bit.bor(CCS.ALL), key="fontcolor_stats", label=COLOR, value={1,1,1,1}, default={1,1,1,1}, slots=1 },


    -- Mythic+ Side Panel
    { type="divider", cat="CHAR-MPLUS", ver=bit.bor(CCS.RETAIL), slots=4 },
    { type="header", cat="CHAR-MPLUS", ver=bit.bor(CCS.RETAIL), key=nil, label=L["HEADER_MYTHIC_PANEL"], slots=4, color={0.7, 0.5, 1.0}, fontSize=20, fontOutline="THICKOUTLINE" },
    { type="divider", cat="CHAR-MPLUS", ver=bit.bor(CCS.RETAIL), slots=4 },
    ...
    { type="header", cat="CHAR-REWARDS", ver=bit.bor(CCS.RETAIL), key=nil, label=L["HEADER_REWARDS"], slots=4, color={0.7, 0.5, 1.0}, fontSize=20, fontOutline="THICKOUTLINE" },
    { type="divider", cat="CHAR-REWARDS", ver=bit.bor(CCS.RETAIL), slots=4 },
    ...
    { type="header", cat="CHAR-RAID", ver=bit.bor(CCS.RETAIL), key=nil, label=L["HEADER_RAID_PROGRESS"], slots=4, color={0.7, 0.5, 1.0}, fontSize=20, fontOutline="THICKOUTLINE" },
    { type="divider", cat="CHAR-RAID", ver=bit.bor(CCS.RETAIL), slots=4 },
    ...
    { type="divider", cat="CHAR-RAID", ver=bit.bor(CCS.RETAIL), slots=4 },
    { type="header", cat="CHAR-RAID", ver=bit.bor(CCS.RETAIL), key=nil, label=L["ON_CHARACTER_SHEET"], slots=4, color={0.7, 0.5, 1.0}, fontSize=16, fontOutline="THICKOUTLINE" },
    { type="divider", cat="CHAR-RAID", ver=bit.bor(CCS.RETAIL), slots=4 },
    ...
    { type="header", cat="INSPECT-SHEET", ver=bit.bor(CCS.ALL), key=nil, label=L["HEADER_INSPECT_DISPLAY"], slots=4, color={0.7, 0.5, 1.0}, fontSize=20, fontOutline="THICKOUTLINE" },
    { type="divider", cat="INSPECT-SHEET", ver=bit.bor(CCS.ALL), slots=4 },
    ...
    { type="dropdown", cat="INSPECT-SHEET", ver=bit.bor(CCS.ALL), key="bgtype_inspect", label=L["INSPECT_BG_TYPE"], value="Default", default="Default", values={"Default", "Class", "Race", "Hide"}, slots=2 },
    ...
    { type="header", cat="INSPECT-FONT", ver=bit.bor(CCS.ALL), key=nil, label=L["HEADER_INSPECT_FONT"], slots=4, color={0.7, 0.5, 1.0}, fontSize=20, fontOutline="THICKOUTLINE" },
    { type="divider", cat="INSPECT-FONT", ver=bit.bor(CCS.ALL), slots=4 },
...
CCS.fonts = {
    ...
    ["Expressway Rg"] = "Interface\\AddOns\\ChonkyCharacterSheet\\Media\\Fonts\\Expressway.TTF",
    ...
    ["PT Sans Narrow"] = "Interface\\AddOns\\ChonkyCharacterSheet\\Media\\Fonts\\PTSansNarrow-Regular.ttf",
...
CCS.fontLabels = {
    ...
    ["PT Sans Narrow"] = {
        ...
        deDE = "PT Sans Schmal",
        zhCN = "PT Sans 窄体",
        esES = "PT Sans Estrecho",
        zhTW = "PT Sans 窄體",
        esMX = "PT Sans Estrecho",
        ruRU = "PT Sans Узкий",
        ptBR = "PT Sans Estreito",
        itIT = "PT Sans Stretto",
    },
    ["Rebellion"] = {
        enUS = "Rebellion",
        koKR = "리벨리온",
...
CCS.ClassSpecStatPriority = {
    [6] = { -- Death Knight
        ...
        [1] = {
            [31] = {2,2,1,2}, -- San'layn
            --[32] = {0,0,0,0}, -- Rider of the Apocalypse
            [33] = {1,1,2,1}, -- Deathbringer
        },
        -- Frost
        [2] = {
            --[31] = {0,0,0,0}, -- San'layn
        ...
        [3] = {
            [31] = {2,3,1,4}, -- San'layn
            [32] = {2,3,1,4}, -- Rider of the Apocalypse
            --[33] = {0,0,0,0}, -- Deathbringer
        },
    },
    [12] = { -- Demon Hunter
        ...
        [1] = {
            ...
            --[124] = {2,1,3,4}, -- Annihilator
        },
        -- Vengeance
        [2] = {
            [34] = {4,2,1,3}, -- Fel-Scarred
    ...
    [11] = { -- Druid
        ...
        [1] = {
            --[21] = {0,0,0,0}, -- Druid of the Claw
            --[22] = {0,0,0,0}, -- Wildstalker
            [23] = {1,2,4,3}, -- Keeper of the Grove
            [24] = {1,3,2,4}, -- Elune's Chosen
        },
        -- Feral
        [2] = {
            [21] = {1,2,3,4}, -- Druid of the Claw
            [22] = {1,2,3,4}, -- Wildstalker
            --[23] = {0,0,0,0}, -- Keeper of the Grove
            --[24] = {0,0,0,0}, -- Elune's Chosen
        },
        -- Guardian
        [3] = {
            [21] = {3,4,1,2}, -- Druid of the Claw
            --[22] = {0,0,0,0}, -- Wildstalker
            --[23] = {0,0,0,0}, -- Keeper of the Grove
            [24] = {3,4,1,2}, -- Elune's Chosen
        },
        -- Restoration
        [4] = {
            --[21] = {0,0,0,0}, -- Druid of the Claw
    ...
    [13] = { -- Evoker
        ...
        [1] = {
            [36] = {4,1,2,3}, -- Scalecommander
            [37] = {4,2,1,3}, -- Flameshaper
            --[38] = {0,0,0,0}, -- Chronowarden
        },
        -- Preservation
        [2] = {
            --[36] = {0,0,0,0}, -- Scalecommander
            [37] = {1,3,2,3}, -- Flameshaper
            [38] = {1,2,3,3}, -- Chronowarden
        },
        -- Augmentation
        [3] = {
            [36] = {3,1,2,4}, -- Scalecommander
            --[37] = {0,0,0,0}, -- Flameshaper
    ...
    [3] = { -- Hunter
        ...
        [1] = {
            --[42] = {0,0,0,0}, -- Sentinel
            [43] = {2,2,1,3}, -- Pack Leader
            [44] = {4,2,1,3}, -- Dark Ranger
        },
        -- Marksmanship
        [2] = {
            [42] = {2,1,4,3}, -- Sentinel
            --[43] = {0,0,0,0}, -- Pack Leader
    ...
    [8] = { -- Mage
        ...
        [1] = {
            [39] = {3,4,1,2}, -- Sunfury
            [40] = {3,4,1,2}, -- Spellslinger
            --[41] = {0,0,0,0}, -- Frostfire
        },
        -- Fire
        [2] = {
            [39] = {3,4,1,2}, -- Sunfury
            --[40] = {0,0,0,0}, -- Spellslinger
            [41] = {4,2,1,3}, -- Frostfire
        },
        -- Frost
        [3] = {
            --[39] = {0,0,0,0}, -- Sunfury
    ...
    [10] = { -- Monk
        ...
        [1] = {
            --[64] = {0,0,0,0}, -- Conduit of the Celestials
            [65] = {2,1,3,1}, -- Shado-pan
            [66] = {2,1,3,1}, -- Master of Harmony
        },
        -- Mistweaver
        [2] = {
            [64] = {4,2,1,3}, -- Conduit of the Celestials
            --[65] = {0,0,0,0}, -- Shado-pan
            [66] = {4,2,1,3}, -- Master of Harmony
        },
        -- Windwalker
        [3] = {
            [64] = {1,2,1,2}, -- Conduit of the Celestials
            [65] = {1,2,1,2}, -- Shado-pan
            --[66] = {0,0,0,0}, -- Master of Harmony
        },
    },
    [2] = { -- Paladin
        ...
        [1] = {
            --[48] = {0,0,0,0}, -- Templar
            [49] = {2,1,1,2}, -- Lightsmith
            [50] = {1,2,1,3}, -- Herald of the Sun
        },
        -- Protection
        [2] = {
            [48] = {2,3,1,3}, -- Templar
            [49] = {3,2,1,3}, -- Lightsmith
            --[50] = {0,0,0,0}, -- Herald of the Sun
        },
        -- Retribution
        [3] = {
            [48] = {1,2,3,4}, -- Templar
            --[49] = {0,0,0,0}, -- Lightsmith
    ...
    [5] = { -- Priest
        ...
        [1] = {
            [18] = {2,2,1,5}, -- Voidweaver
            --[19] = {0,0,0,0}, -- Archon
            [20] = {2,2,1,5}, -- Oracle
        },
        -- Holy
        [2] = {
            --[18] = {0,0,0,0}, -- Voidweaver
            [19] = {2,1,4,3}, -- Archon
            [20] = {2,1,4,3}, -- Oracle
        },
        -- Shadow
    ...
    [4] = { -- Rogue
        ...
        [1] = {
            --[51] = {0,0,0,0}, -- Trickster
            [52] = {1,2,3,4}, -- Fatebound
            [53] = {1,2,3,4}, -- Deathstalker
        },
        -- Outlaw
        [2] = {
            [51] = {4,3,2,1}, -- Trickster
            [52] = {4,3,2,1}, -- Fatebound
            --[53] = {0,0,0,0}, -- Deathstalker
        },
        -- Subtlety
        [3] = {
            [51] = {1,3,4,2}, -- Trickster
            --[52] = {0,0,0,0}, -- Fatebound
            [53] = {1,3,4,2}, -- Deathstalker
        },
    },
    [7] = { -- Shaman
    ...
    [9] = { -- Warlock
        ...
        [1] = {
            [57] = {2,1,3,4}, -- Soul Harvester
            [58] = {2,1,3,4}, -- Hellcaller
            --[59] = {0,0,0,0}, -- Diabolist
        },
        -- Demonology
        [2] = {
            [57] = {2,1,1,3}, -- Soul Harvester
            --[58] = {0,0,0,0}, -- Hellcaller
            [59] = {2,1,1,3}, -- Diabolist
        },
        -- Destruction
        [3] = {
            --[57] = {0,0,0,0}, -- Soul Harvester
